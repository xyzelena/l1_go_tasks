...
## Задача 24 - Task 24 Function Sleep 
...
## Задача 25 - Task 25 Checking the uniqueness of characters in a string

В данном примере разработана программа, которая проверяет, что все символы в строке встречаются один раз (т.е. строка состоит из уникальных символов).
Вывод: true, если все символы уникальны, false, если есть повторения. Проверка является регистронезависимой, т.е. символы в разных регистрах считать одинаковыми.
